...
_SCRIPT_USAGE="sudo bash $(basename "$0") [flags]" # default value
...
# seta o modo de uso do script, para ser utilizado no print_usage()
# não é obrigatório de se utilizar para a aplicação funcionar!
# funciona igual o set_description
# Uso: set_script_usage "$FULL_SCRIPT_PATH -m -e <test>"
set_usage() {
    _SCRIPT_USAGE="$1"
}
...
print_usage() {
    echo "Usage:"
    # sed _script_usage and add spaces to align description
    # after sed, drop output to terminal
